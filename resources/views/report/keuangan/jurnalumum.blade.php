                ...
                <div class="card-header">
                    <div class="d-flex">
                        @if (request('startDate') && request('endDate'))
                            <a href="{{ route('admin.report.keuangan.jurnalumum') }}"
                                class="btn btn-danger btn-sm mr-1"><i class="fa fa-arrow-left"></i></a>
                    ...
                    <div>
                        <form action="{{ route('admin.report.keuangan.jurnalumum.cari') }}" method="GET">
                            ...
                            <div class="d-flex">
                                ...
                                @enderror
                                <button type="submit" class="btn btn-secondary btn-sm" style="width: 70px"><i
