                ...
                <div class="col-lg-12 col-md-6 col-12">
                    ...
                    <div class="card-header">
                        <div class="d-flex">
                            @if (request('startDate') && request('endDate'))
                                <a href="{{ route('admin.report.keuangan.kas','Bkm') }}" class="btn btn-danger btn-sm mr-1"><i class="fa fa-arrow-left"></i></a>
                        ...
                        <div>
                            <form action="{{ route('admin.report.keuangan.kas.cari','Bkm') }}" method="GET">
                            @csrf
                                <div class="d-flex">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            @if (request('startDate') && request('endDate'))
                                {{ $bkm->links('pagination::bootstrap-4') }}
                            @endif
                        </div>
                    </div>
                </div>
