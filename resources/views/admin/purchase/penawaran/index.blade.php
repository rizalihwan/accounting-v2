                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('admin.purchase.penawaran.show', $penawaran->id) }}">
                                                <i data-feather="eye"></i>
                                                <span class="ml-1">Show</span>
                                            </a>
                                            <a class="dropdown-item" href="{{ route('admin.purchase.penawaran.edit', $penawaran->id) }}">
                                            ...
                                            <form id="form-delete{{ $penawaran->id }}" action="{{ route('admin.purchase.penawaran.destroy', $penawaran->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </div>
