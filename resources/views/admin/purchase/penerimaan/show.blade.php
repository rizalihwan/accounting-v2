...
<li class="breadcrumb-item">
    <a href="{{ route('admin.purchase.terima.index') }}">Pesanan</a>
</li>
  ...
  <div class="col-md-12">
      <div class="card py-2">
          ...
          <div class="card-body pt-2">
              ...
              <div class="table-responsive">
                  <table class="table mt-2">
                      ...
                      <tbody>
                          @foreach ($pengiriman->pengiriman_details as $item)
                              <tr>
                      ...
                      <tfoot>
                          <tr>
                              ...
                              <th></th>
                              <th>
                                {{ 'Rp. ' . number_format($pengiriman->total, 0, ',', '.') }}
                              </th>
                          </tr>
                      </tfoot>
                  </table>
          ...
          <div class="card-footer">
            <a class="btn btn-primary" href="{{ route('admin.purchase.terima.index') }}">
              Kembali</a>
          </div>
      </div>
  </div>
